...
from organdetr.models.criterion import OrgandetrCriterion
from organdetr.models.backbones.attn_fpn.attn_fpn import AttnFPN
from organdetr.models.necks.def_detr_transformer import DeformableTransformer
from organdetr.models.position_encoding import PositionEmbeddingSine3D, PositionEmbeddingLearned3D

from organdetr.models.backbones.resnet3d import ResNet3D
from organdetr.models.backbones.MSAViT import MSAViT
from organdetr.models.backbones.swin_unetr import Swin_UNETR
...
def build_criterion(config):
    ...
    print(f"==============config['neck']['num_classes']={config['neck']['num_classes']}")
    if config.get('hybrid_dense_matching', False):
        ...
        hybrid_dense_criterion = OrgandetrCriterion(
