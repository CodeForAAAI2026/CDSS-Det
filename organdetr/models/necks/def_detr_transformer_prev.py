...
class DeformableTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False, use_dab=False, d_model=256, high_dim_query_update=False, no_sine_embed=True, num_classes=0):
        super().__init__()
...
class DeformableTransformer(nn.Module):
    def __init__(
        ...
        self.decoder = DeformableTransformerDecoder(decoder_layer, num_decoder_layers, return_intermediate_dec,
                                                    ...
                                                    no_sine_embed=False, num_classes=num_classes)
        if self.is_contrastive:
