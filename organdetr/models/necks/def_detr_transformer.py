...
from organdetr.models.ops.modules import MSDeformAttn
...
class DeformableTransformerDecoder(nn.Module):
    def __init__(self, decoder_layer, num_layers, return_intermediate=False, use_dab=False, d_model=256, high_dim_query_update=False, no_sine_embed=True, num_classes=0, dn=False):
        super().__init__()
    ...
    def forward(self, tgt, reference_points, src, src_spatial_shapes, src_level_start_index, src_valid_ratios,
        ...
        for lid, layer in enumerate(self.layers):
            ...
            if torch.isnan(output).any():
                print(f"NaN detected in output, lid={lid}, before layer")
            ...
            if torch.isnan(output).any():
                print(f"NaN detected in output, lid={lid}, after layer")
