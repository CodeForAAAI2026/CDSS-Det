...
from organdetr.pixpro_baseline_trainer import PixProTrainer
...
def train(config, args):
    ...
    labeled_train_loader = get_loader(config, 'labeled_train', batch_size=config['batch_size'])
    ...
    config['pixpro']['num_instances'] = len(unlabeled_train_loader)
    ...
    trainer = PixProTrainer(
        labeled_train_loader, unlabeled_train_loader, val_loader, model, criterion, optim, scheduler, device, config, 
